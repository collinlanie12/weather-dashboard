...
$(document).ready(function () {
    ...
    var lastShow = JSON.parse(localStorage.getItem("lastSearch"));
    if (lastShow === null) {
        lastShow = "Charlotte";
    }
    var apiKey = "5fc8342540b36c6541d1d1659b328759";
    var queryURLCurrent = "https://api.openweathermap.org/data/2.5/weather?q=" + lastShow + "&units=imperial&appid=" + apiKey;
    var queryURLForecast = "https://api.openweathermap.org/data/2.5/forecast?q=" + lastShow + "&units=imperial&appid=" + apiKey;
    ...
    $.ajax({
        ...
        .then(function (response) {
            ...
            var city = $("<h3>" + lastShow + "<br>" + moment().format("LL") + "</h3>");
...
function displayButtonInfo() {
    ...
    var apiKey = "5fc8342540b36c6541d1d1659b328759";
    var queryURLCurrent = "https://api.openweathermap.org/data/2.5/weather?q=" + button + "&units=imperial&appid=" + apiKey;
    var queryURLForecast = "https://api.openweathermap.org/data/2.5/forecast?q=" + button + "&units=imperial&appid=" + apiKey;
    $.ajax({
        url: queryURLCurrent,
        method: "GET"
    })
        .then(function (response) {
            ...
            var city = $("<h3>" + button + "<br>" + moment().format("LL") + "</h3>");
            city.attr("class", "col-md-12 mt-4");
            mainCardInside.append(city);
...
$("#searchbtn").on("click", function () {
    ...
    localStorage.setItem("lastSearch", JSON.stringify(searches.slice(-1)[0]));
...
$(document).on("click", ".cityBtn", displayButtonInfo);
